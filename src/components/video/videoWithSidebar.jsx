      ...
      <div className="flex flex-row w-full gap-x-4 mb-5">
        ...
        <div className="w-[90%] lg:w-2/3">
          ...
          <div className='w-full bg-[#474747] relative h-4 xs:h-6 sm:h-7 md:h-8 lg:h-16'>
            <div className='row'>
              <div className='col-md-12 flex justify-center items-center text-[#3D61AB] text-[1.3rem] xs:text-[1rem] sm:text-[2.2rem] md:text-[2.5rem] lg:text-[3em] uppercase' style={{fontFamily:"cursive",fontWeight:"bolder"}}>
                {video?.video_title}
              </div>
            </div>
            &nbsp;
