...
const CourseSidebar = ({ coursedata }) => {
  ...
  return (
    <div className="border p-5 xl:p-9 rounded-xl border-[#3D61AB]">
      <span className="justify-end lg:flex hidden">
        <FaBars color="#3D61AB" size={25} />
      </span>
      ...
      <Accordion className="border border-[#3D61AB] p-4 px-5 rounded-xl w-full">
