...
const HomeSections = () => {
  ...
  return (
    ...
    >
      ...
      {/* FEATURED COURSES */}
      <section className="py-12 md:py-20 bg-white px-4 sm:px-8 lg:px-12">
        <h2 className="text-center text-2xl sm:text-4xl font-[600] mb-10">
          Featured Courses
        </h2>
      ...
      <section className="py-16 bg-gray-100 px-4 sm:px-6 lg:px-10">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl sm:text-4xl font-[500] text-black mb-10">
            What Our Users Say
          </h2>
          <div
