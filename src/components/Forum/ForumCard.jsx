...
//         setLoader(true);
//         const values = { comnt: trimmedComment, replyid };
//         try {
...
//                     setRepliesData(prev => ({
//                         ...prev,
//                         [replyid]: [...(prev[replyid] || []), Data.data],
//                     }));
//                     setShowReplies(prev => ({
//                         ...prev,
//                         [replyid]: true,
...
//                                                             <div key={reply.id} className="flex items-start gap-2 p-2 bg-[#4a5e52] rounded-lg">
//                                                                 <Image
