      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="w-full md:w-1/2 text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-[#88B29A] mb-6">
              What We Do
            </h2>
            <div className="space-y-4 w-[100%] text-gray-900 text-[14px] sm:text-[14px]">
              ...
              <div className="mt-6">
                <Link
                  href="#learn-more"
                  className="inline-flex font-semibold items-center bg-[#88B29A] text-white px-5 py-2 rounded hover:bg-[#7aa18e] transition-colors"
                >
