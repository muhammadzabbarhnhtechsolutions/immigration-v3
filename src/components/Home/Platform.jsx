        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold mb-4">
              The complete <span className="text-[#3D61AB]">platform</span>
            </h2>
            ...
            <div className="space-y-8 ">
              <div
                ...
                className={`cursor-pointer p-6 rounded-lg ${
                  activeTab === "video"
                    ? "bg-[#3D61AB] border border-[#88b29a] shadow-4xl"
                    : "bg-white"
                }`}
                style={{
                  boxShadow:
              ...
              <div
                ...
                className={`cursor-pointer p-6 rounded-lg shadow-sm ${
                  activeTab === "written" ? "bg-[#3D61AB] border border-[#88b29a]" : "bg-white"
                }`}
                style={{
                  boxShadow:
                    activeTab === "written"
              ...
              <div
                ...
                className={`cursor-pointer p-8 rounded-lg shadow-sm ${
                  activeTab === "templates" ? "bg-[#3D61AB] border border-[#88b29a]" : "bg-white"
                }`}
                style={{
                  boxShadow:
                    activeTab === "templates"
              ...
              <button className="bg-[#3D61AB] flex gap-2 item-center cursor-pointer text-white px-6 py-2 rounded hover:bg-[#76998a] transition-colors">
