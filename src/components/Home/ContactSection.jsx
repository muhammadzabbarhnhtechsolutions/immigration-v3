    ...
    <section className="py-16 md:px-14 bg-[#E6EDE9] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Contact Form */}
          <div
            style={{ boxShadow: "0px 4px 0px 17px rgba(139, 172, 154, 0.12)" }}
          ...
          >
            ...
            <p className="text-center text-[#88B29AAD] uppercase text-sm font-semibold tracking-wider mb-6">
              Contact us.
            </p>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-[#88B29AAD] bg-opacity-50 slide-in backdrop-blur-sm p-6 rounded-lg transition-transform transform duration-500 ease-in-out ">
                <h3 className="uppercase text-sm font-sans font-semibold text-white mb-4">
                  Contact Us
                </h3>
              ...
              <div className="bg-[#88B29AAD] bg-opacity-50 slide-in backdrop-blur-sm p-6 rounded-lg transition-transform transform duration-500 ease-in-out ">
                <h3 className="uppercase text-sm font-semibold text-white mb-4">
                  Our Working Hours
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
