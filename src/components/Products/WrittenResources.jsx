        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-20">
          <div className="text-center mb-8">
            <h2 className="text-3xl md:text-4xl font-semibold mb-2">
              Written <span className="text-[#90B29F]">Resources</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 mt-12">
            ...
            <div className="text-center lg:text-left ">
              <h3 className="text-2xl leading-relaxed md:text-3xl font-medium text-[#90B29F] mb-6">
              ...
              <Link
                href="/pricing"
                className="inline-flex items-center justify-center bg-[#90B29F] text-white px-6 py-3 rounded-md font-medium hover:bg-[#90B29F] transition-colors"
              >
                See Pricing Plans
                <svg
