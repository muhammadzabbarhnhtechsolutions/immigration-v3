    ...
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-12">
        <h1 className="text-2xl md:text-4xl font-medium mb-2">
          ...
          <span className="text-[#3D61AB]">Templates</span>
        </h1>
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-16">
        ...
        <div className="md:w-1/2 flex flex-col md:mb-28 justify-center">
          <h2 className="text-2xl md:text-[34px] font-semibold text-[#3D61AB] mb-4 leading-relaxed">Time-saving and effective</h2>
          <p className="text-base mb-8 text-gray-700">Save time, worry and stress through use of our proven templates.</p>
          <div>
            <Link
              href="/pricing"
              className="bg-[#3D61AB] text-white px-6 py-3 text-base rounded-md inline-block hover:bg-[#6a9a7d] transition-colors"
            >
              See Pricing Plans →
            </Link>
          </div>
