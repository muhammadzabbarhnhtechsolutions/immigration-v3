...
export default function Navbar() {
  ...
  return (
    <div className="w-full  md:mb-8 relative z-[100]">
      ...
      >
        {/* Top Contact Bar */}
        <div className="bg-[#88B29A]  text-white px-14 py-2 hidden md:flex justify-between items-center text-sm">
            ...
            {!checklogin || checklogin === "undefined" ? (
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full hover:ring-2 hover:ring-[#88B29A] transition"
                >
        ...
        <div className="bg-white px-4 md:px-18 py-2 flex justify-between items-center shadow-md">
          ...
          {/* .. */}
          <nav className="hidden md:flex gap-[15px] text-[#88B29A] font-sans text-[16px]">
            {[
              { href: "/", label: "Home" },
          ...
          <button
            ...
            className="text-[#88B29A] cursor-pointer text-2xl md:hidden"
          >
        ...
        {isMobileMenuOpen && (
          <div className="bg-white px-6 py-4 h-screen flex flex-col space-y-4 md:hidden border-t-2 border-gray-100 shadow-md overflow-y-auto">
            ...
            {Array.isArray(resources) && resources.length > 0 && (
              <>
                <button
                  ...
                  className="flex items-center justify-between w-full text-[#88B29A] font-semibold mt-4"
                >
                  <span>Resources</span>
                  {isMobileResourcesOpen ? (
                    <FaChevronUp className="text-[#88B29A]" />
                  ) : (
                    <FaChevronDown className="text-[#88B29A]" />
                  )}
                </button>

                {isMobileResourcesOpen && (
                  <div className="flex flex-col text-[#88B29A]  space-y-1 pl-4">
                    {resources.map((resource, idx) => {
                      ...
                      return (
                        <Link
                          ...
                          href={href}
                          onClick={() => setIsMobileMenuOpen(false)}
                          className="text-base text-[#88B29A] leading-relaxed hover:text-[#51956d] transition"
                        >
                          {resource === "Create Blog"
                            ? "Create Blog"
                            : resource}
              ...
              <>
                {userData?.packages?.some((pkg) => pkg.package_type === 3) && (
                  <Link
                    ...
                    className="flex items-center gap-2 text-[#88B29A]"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
            ...
            <div className="flex flex-col space-y-2 pt-4 border-t-2 border-gray-100">
              <span className="flex items-center gap-2 text-[#88B29A]">
                <FaPhone /> 07578979789
              </span>
              <span className="flex items-center gap-2 text-[#88B29A]">
                <FaEnvelope /> immigration@training.com
            ...
            <Link
              ...
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <button className="bg-[#88B29A] mt-4 w-full flex items-center justify-center gap-2 text-white text-sm font-semibold py-3 rounded-md hover:bg-[#7fa98b]">
                REQUEST A DEMO <FaArrowRight />
              </button>
            </Link>
          </div>
