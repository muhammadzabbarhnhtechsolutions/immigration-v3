  ...
  return (
    <main className="px-4 md:px-16 py-16 mt-12 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10">
        <h1 className="text-2xl md:text-3xl md:-ml-8 font-bold text-[#3D61AB]">Reference Materials</h1>
      ...
      {loading && (
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
          ...
          <p className="text-[#3D61AB] text-lg font-medium">Loading materials…</p>
        </div>
      )}
      ...
      {!loading && documents.length === 0 && (
        <div className="col-span-full flex flex-col items-center text-center mt-28 text-gray-500">
          ...
          <p className="text-xl font-medium text-[#3D61AB]">No Material found</p>
