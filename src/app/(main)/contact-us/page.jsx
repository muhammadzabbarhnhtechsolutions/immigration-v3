      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8">
        ...
        <div className="bg-white p-8 rounded-sm border-2 border-[#e6e8e7]/30 shadow-2xl w-full md:w-3/4">
          <h2 className="text-3xl font-semibold mb-2">
            Contact <span className="text-[#3D61AB]">Us</span>
          </h2>
          <p className="text-[#3D61AB] mb-8 font-sans">WE'D LOVE TO HEAR FROM YOU</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-[#3D61AB] border-[#3D61AB]"
              />
              <input
                type="text"
                name="lastName"
            ...
            <button
              type="submit"
              className="bg-[#3D61AB] cursor-pointer text-white px-8 py-2 rounded-md hover:bg-[#76998a] transition-colors"
            >
              SUBMIT
            </button>
          </form>
        ...
        {/* Right Contact Info */}
        <div className="bg-[#3D61AB] p-8 rounded-md text-white w-full md:w-1/4 slide-in">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <div className="bg-white rounded-full p-1">
              <svg className="w-5 h-5 text-[#3D61AB]" viewBox="0 0 24 24" fill="currentColor">
