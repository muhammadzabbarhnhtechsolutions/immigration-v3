    ...
    <div className="max-w-2xl mx-auto z-[100] bg-white rounded-xl shadow-xl p-6 space-y-4">
      <div className="grid gap-4">
        <input
          ...
          className="border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#88B29A] focus:border-[#88B29A]"
          value={title}
      ...
      >
        <div className="flex flex-col items-center space-y-3">
          <Upload className="text-[#88B29A] w-10 h-10" />
      ...
      <button
        ...
        disabled={uploading}
        className="mt-4 w-full bg-[#88B29A] hover:bg-green-600 text-white font-semibold py-3 rounded-lg transition"
      >
      ...
      {uploading && (
        <div className="mt-4 w-full bg-gray-200 rounded h-3 overflow-hidden">
          <div
 className="mt-6 inline-block px-6 py-2.5 rounded-full bg-[#88B29A] text-white font-semibold shadow-md transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl active:scale-95"            style={{ width: `${progress}%` }}
          />
        </div>
      )}
