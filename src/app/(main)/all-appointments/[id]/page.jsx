        ...
        <div className="bg-[#5AAA7C] h-36 rounded-t-xl w-full flex justify-center items-center relative">
          ...
          {card.dropdown && (
            <div className="absolute top-4 right-4 group">
              <MoreVertical className="text-white cursor-pointer" size={20} />
              <div className="absolute right-0 mt-2 hidden group-hover:block bg-white rounded-lg shadow-lg text-sm text-gray-700 z-10 w-44">
                {card.title === "Meetings" ? (
                  <>
                    <Link
  ...
  >
    <div className="flex flex-col items-center space-y-3">
      ...
      <input
        ...
        accept=".pdf,.doc,.docx"
      />
      <p className="text-xs sm:text-sm text-gray-400">Supported: PDF, Word</p>
    </div>
  </div>
