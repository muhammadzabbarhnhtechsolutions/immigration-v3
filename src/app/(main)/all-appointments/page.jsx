...
const AppointmentCard = ({ appointment }) => {
  ...
  return (
    <>
      ...
      >
    <div className="relative bg-gradient-to-br from-[#88B29A]/90 to-[#88B29A]/90 rounded-3xl px-6 py-12 w-full sm:w-[363px] text-white text-center shadow-2xl hover:scale-105 transition-transform duration-300">
...
export default function AppointmentCards() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 mt-0 py-12">
      <h2 className="text-3xl mt-6 font-bold text-[#88B29A] mb-20">
        All Appointments
      </h2>
