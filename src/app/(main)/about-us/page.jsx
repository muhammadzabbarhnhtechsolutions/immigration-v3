    ...
    <main className="min-h-screen md:mx-12 bg-white">
      ...
      <section className="container  md:px-4 py-12 md:py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="mx-12 mt-12">
          ...
          <button className="mt-6 flex cursor-pointer items-center bg-[#88B29A] text-white px-6 py-3 rounded-md font-medium hover:bg-[#88B29A] transition-colors">
      ...
      <section className="bg-[#88B29A14] container  px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div className="p-6 rounded-lg">
            <h2 className="text-2xl md:text-[35px] font-bold text-[#88B29A] font-sans mb-4">Our Story</h2>
...
<section className="container mx-auto px-2 py-12 mb-12">
  <div className="bg-[#88B29A] p-6 md:p-12 flex flex-col md:flex-row md:justify-between items-center rounded-lg gap-6">
    ...
    {/* Right Button */}
    <div>
      <button className="bg-white flex items-center justify-center px-6 py-3 text-[#88B29A] rounded-md font-medium hover:bg-[#88B29A] hover:text-white transition-colors">
