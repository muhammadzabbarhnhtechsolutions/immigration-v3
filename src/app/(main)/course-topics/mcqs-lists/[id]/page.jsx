...
Available MCQS Test        </h4>            </div>
 ...
 <div className="mx-autopx-4 mt-0 py-20 text-center flex flex-col items-center justify-center gap-4 animate-fade-in">
        ...
        <p className="text-gray-500 text-center text-lg">No tests available.</p>
              ...
              <div className="grid sm:grid-cols-2 mt-6 lg:grid-cols-3 gap-6">
            {tests?.map((test, index) => (
          <div
  key={index}
  className="group relative overflow-hidden rounded-2xl bg-white p-1 transition-all duration-500 hover:scale-[1.03] hover:shadow-2xl hover:shadow-[#88B29A]/20"
>
  ...
  <div className="relative flex h-full flex-col justify-between rounded-[calc(1rem-1px)] bg-white p-6">
    ...
    <div className="mt-4">
      <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#88B29A]/10 text-[#88B29A] transition-transform duration-500 group-hover:rotate-12">
        {/* Simple Icon (Book or Check) */}
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
      </div>

      <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-800 transition-colors group-hover:text-[#88B29A]">
        {test.title || `Test ${index + 1}`}
      </h2>
      
      <p className="line-clamp-4 text-sm leading-relaxed text-gray-500">
        {test.description || "Master this topic with our curated selection of high-yield questions."}
      </p>
    </div>
