...
export default function McqsTestListPage() {
  ...
  return (
        ...
        <Sparkles className="text-[#88B29A] w-6 h-6" />
        <h1 className="text-3xl font-bold text-[#88B29A]">Available MCQ Tests</h1>
            </div>
        ...
        <p className="text-gray-500 text-center text-lg">No tests available.</p>
            ...
            {tests?.map((test, index) => (
               <div
                ...
                >
              <div className="absolute top-0 right-0 bg-[#88B29A] text-white text-xs px-3 py-1 rounded-bl-xl rounded-tr-xl">
                Test #{index + 1}
              </div>
              <h2 className="text-xl font-semibold text-[#88B29A] mb-2 group-hover:text-[#88B29A] transition">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="px-5 py-2 bg-[#88B29A] text-white rounded-full hover:bg-[#88B29A] transition font-medium"
                >
