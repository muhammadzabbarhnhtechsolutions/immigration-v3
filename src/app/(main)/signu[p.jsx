    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="bg-[#f2f6f4] p-8 rounded-lg shadow-sm w-full max-w-md">
          <h1 className="text-2xl text-center text-[#88B29A] mb-8">Register</h1>
...
>
  ...
  <Link href="/login">
            <button
              type="submit"
              disabled={loading}
               className="mt-6 inline-block px-6 py-2.5 rounded-full bg-[#88B29A] text-white font-semibold shadow-md transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl active:scale-95"
            >
              Register
            </button>
            </Link>
