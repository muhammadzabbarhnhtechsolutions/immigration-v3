      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-6 max-w-6xl mx-auto md:mx-6">
        {resources.map((resource, index) => {
          ...
          return (
            ...
            >
              <div className="w-24 h-24 bg-[#88B29AC9] rounded-full flex items-center justify-center mb-3 overflow-hidden">
              ...
              <span className="text-xl font-bold text-[#88B29AC9]">{title}</span>
            </Link>
          );
        })}
      </div>
