      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2  gap-12 items-start">
        ...
        <div className="bg-white p-6  sm:p-8 rounded-sm shadow-lg w-full max-w-xl mx-auto">
          <h3 className="text-2xl font-semibold mb-6 text-gray-800">
            <span className="border-b-3 pb-2 border-[#88B29A]">Reque</span>st A{' '}
            <span className="text-[#88B29A]">Demo</span>
          </h3>
          ...
          <form className="space-y-4 mb-6">
            ...
            <div className="flex justify-center items-center">
              <button
                type="submit"
                className="bg-[#88B29A] cursor-pointer text-white px-6 py-2 rounded-md mt-2 hover:bg-[#769b8e] transition-colors"
              >
                SUBMIT
              </button>
            </div>
